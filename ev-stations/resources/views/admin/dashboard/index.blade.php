                  ...
                  <tr>
                    ...
                    <td>
                      <div class="avatar-group">
                        ...
                        <a href="#" class="avatar avatar-sm rounded-circle" data-toggle="tooltip" data-original-title="Jessica Doe{{asset('                          <')}}img alt="Image placeholder" src="{{asset('assets/img/theme/team-4.jpg')}}">
                        </a>
                      </div>
                    </td>
                    <td>
