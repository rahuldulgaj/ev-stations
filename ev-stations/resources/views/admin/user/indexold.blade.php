    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
                            ...
                            <form action="{{route('user.search')}}" method="GET" class="form-horizontal">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        ...
                                        <a class="btn btn-md btn-info " href="{{ route('user.create') }}" ><i class="fa fa-plus"> </i>Add Employee</a>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                             <h5 class="card-title m-b-0">Admin</h5>
                              <!-- <a href="{{route('user.create')}}" class="btn btn-md btn-danger">Create User</a> -->
                            ...
                            <div class="table-responsive">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        <th>{{$loop->index+1}}</th>
                                        <td>{{$user->username}}</td>
                                        <td><img src="{{ asset('uploads/gallery/EMP' . $user->image) }}" width="80px" height="80px" alt="Image"> </td>
                                        <td>{{$user->role}}</td>
                                        <td>{{$user->email}}</td>
                                        <td>
            ...
            <footer class="footer text-center">
                All Rights Reserved by Brainydx Informatics Pvt. Ltd. Designed and Developed by <a href="#">BrainyDx</a>.
            </footer>
        </div>
        </div>
    </div>
