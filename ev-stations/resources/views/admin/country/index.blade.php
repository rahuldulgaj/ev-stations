        ...
        <form action="{{route('admin.country.search')}}" method="GET" class="form-horizontal">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="search" class="form-control" id="firstname" placeholder="country Name">
                    </div>
                </div>
            </div>
              ...
              <div class="table-responsive">
                ...
                <div class="col-sm-12 col-md-6"><div id="dataTable_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                  <thead>
                    ...
                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 58px;">country Name</th>
                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 58px;">country Code</th>
                  ...
                  <tfoot>
                    ...
                    <th rowspan="1" colspan="1">Country Name</th>
                    <th rowspan="1" colspan="1">Country Code</th>
                  ...
                  @foreach($countries as $country)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="sorting_1">{{$country->countrycode}}</td>
                                        <td class="sorting_1">{{$country->created_at}}</td>
                                        @if($country->status== '1')
                                            <td>Active</td>
                                        @else
                                            <td>Deactive</td>
