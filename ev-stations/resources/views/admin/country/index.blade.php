            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active"><a href="{{route('admin.country.index')}}">Country</a></li>
        ...
        <form action="{{route('admin.country.search')}}" method="GET" class="form-horizontal">
            ...
            <div class="border-top">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.country.index')}}" class="btn btn-sm btn-neutral">Clear</a>
                    <a class="btn btn-sm btn-neutral" href="{{ route('admin.country.create') }}" ><i class="fa fa-plus"> </i>Add country</a>
                </div>
            </div>
        </form>
    </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  ...
                  <th scope="col" class="sort" data-sort="id">Id</th>
                    ...
                    <th scope="col" class="sort" data-sort="code">Country Code</th>
                ...
                @foreach($countries as $country)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="sorting_1">{{$country->countrycode}}
                                       </td>
