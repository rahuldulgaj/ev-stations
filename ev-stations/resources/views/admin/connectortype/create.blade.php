 ...
 <div class="card shadow mb-4">
          ...
          <div class="row align-items-center py-4">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card shadow mb-4">
                        <form action="{{route('admin.connectortype.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control" id="name" placeholder="Enter Connector Type">
                                    </div>
                                </div>
                                <!-- <div class="form-group row">
