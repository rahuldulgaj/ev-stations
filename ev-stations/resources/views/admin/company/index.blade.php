        ...
        <form action="{{route('admin.company.search')}}" method="GET" class="form-horizontal">
            ...
            <div class="border-top">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.company.index')}}" class="btn btn-sm btn-neutral">Clear</a>
                    <a class="btn btn-sm btn-neutral" href="{{ route('admin.company.create') }}" ><i class="fa fa-plus"> </i>Add Company </a>
                </div>
            </div>
        </form>
    </div>
                ...
                @foreach($companies as $company)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-form-{{ $company->id }}" action="{{route('admin.company.destroy',$company->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
