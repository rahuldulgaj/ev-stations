              ...
              <table class="table align-items-center table-flush">
                ...
                @foreach($automatedstatus as $automated)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="sorting_1">{{$automated->code}} </td>
                                      
                                        <td class="sorting_1">{{$automated->company}} </td>  
                                        <td class="sorting_1"><img src="{{ url('storage/uploads/gallery/automated/'.$automated->image) }}" alt="" title="" /></td>
                                        <td class="sorting_1">{{$automated->created_at}}</td>
                                        @if($automated->status== '1')
                                            <td>Active</td>
                                        @else
                                            <td>Deactive</td>
                                         @endif
                                  ...
                                  <form id="delete-form-{{ $automated->id }}" action="{{route('admin.automatedstatus.destroy',$automated->id)}}" method="POST">
                                                @csrf
                                                @method('DELETE')
