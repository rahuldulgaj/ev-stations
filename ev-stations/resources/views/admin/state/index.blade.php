...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <h4 class="page-title">State Management</h4>
    </div>
...
<div class="col-md-12">
    <div class="card shadow mb-4">
        ...
        <form action="{{route('admin.state.search')}}" method="GET" class="form-horizontal">
            <div class="card-body">
                <!-- <h4 class="card-title">Search</h4> -->
                <div class="form-group row">
                    <!-- <label class="col-sm-3 text-right control-label col-form-label"></label> -->
                    <div class="col-sm-8">
                        <input type="text" name="search" class="form-control" id="firstname" placeholder="State Name">
                    </div>
                </div>
            </div>
            <div class="border-top">
                <div class="card-body">
                    ...
                    <a href="{{route('admin.state.index')}}" class="btn btn-md btn-danger">Clear</a>
                    <a class="btn btn-md btn-info " href="{{ route('admin.state.create') }}" ><i class="fa fa-plus"> </i>Add State</a>
                </div>
            </div>
        </form>
    </div>
              ...
              <div class="table-responsive">
                ...
                <div class="col-sm-12 col-md-6"><div id="dataTable_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="dataTable"></label></div></div></div><div class="row"><div class="col-sm-12"><table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                  <thead>
                    ...
                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 58px;">State Name</th>
                    <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 58px;">State Code</th>
                  ...
                  <tfoot>
                    ...
                    <th rowspan="1" colspan="1">State Code</th>
                  ...
                  @foreach($states as $state)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td class="sorting_1">{{$state->statecode}}</td>
                                        <td class="sorting_1">{{$state->created_at}}</td>
                                        @if($state->status== '1')
                                            <td>Active</td>
                                        @else
                                            <td>Deactive</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.state.edit',$state->id)}}" class="btn btn-sm btn-info">Edit</a>
                                            <a href="{{route('admin.state.show',$state->id)}}" class="btn btn-success btn-sm waves-effect">View</a>                                        </a>
                                          
                                            <form id="delete-form-{{ $state->id }}" action="{{route('admin.state.destroy',$state->id)}}" method="put">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" onclick="deletePost({{ $state->id }})" class="btn btn-sm btn-danger">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
