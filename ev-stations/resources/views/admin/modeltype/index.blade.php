                  ...
                  @foreach($modeltypes as $modeltype)
                                    ...
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('admin.modeltype.show',$modeltype->id)}}" class="btn btn-success btn-sm waves-effect">View</a>                                        </a>
                                          
                                            <form id="delete-form-{{ $modeltype->id }}" action="{{route('admin.modeltype.destroy',$modeltype->id)}}" method="put">
                                                @csrf
                                                @method('DELETE')
