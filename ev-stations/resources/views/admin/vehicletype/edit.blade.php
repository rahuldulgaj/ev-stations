 ...
 <div class="card shadow mb-4">
          ...
          <div class="row align-items-center py-4">
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="card">
                        <form action="{{route('admin.vehicletype.update',$vehicletype->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PUT') }}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select type="text" name="status" class="form-control" id="status" placeholder="Status">
                                            ...
                                            <option value="2" {{ $vehicletype->status=='2' ? 'selected' : '' }}>Deactive</option>
                                        </select>
                                    </div>
                                    </div>
